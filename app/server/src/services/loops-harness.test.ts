...
let buildNudgeText: (typeof import('./briefing-nudge.js'))['buildNudgeText']
...
beforeAll(async () => {
  ...
  ;({ buildNudgeText } = await import('./briefing-nudge.js'))
})
...
describe('briefing-nudge — buildNudgeText (deterministic fallback)', () => {
