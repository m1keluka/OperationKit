...
SCRIPT_PATH="/home/operator/projects/operationkit/scripts/disk-cleanup.sh"
MARKER="# command-center: disk-cleanup"
HOST_BOOT_SRC="/home/operator/projects/operationkit/scripts/host-boot.d/40-disk-hygiene.sh"
