...
const WORKSPACES = [
  ...
  { slug: 'example2', name: 'Example3', short_label: 'GF', badge_color: null, vault_path: null, doc_read_roots: [], doc_write_roots: [], default_agent_pool: [], archived: false, sort_order: 1, created_at: '', updated_at: '' },
